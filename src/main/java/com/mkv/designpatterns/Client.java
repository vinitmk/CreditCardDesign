...
public class Client {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) System.out.print("No Valid Input File");
		else {
			inputFile = args[0];
			...
			// 2. Read Input File
			if (null == fileStrategy) {
				System.out.println(
						"File not supported yet. Please use one of the following file types: CSV, XML, JSON");
			} else {
				...
				for (FileInputObject fileObject : fileObjectList) {
					...
					if (cardType != null) {
						...
						case AmericanExpress:
							factory = new AmericanExpressCardFactory();
							break;
						case Discover:
							factory = new DiscoverCardFactory();
							break;
						case MasterCard:
							factory = new MasterCardFactory();
							break;
						case Visa:
